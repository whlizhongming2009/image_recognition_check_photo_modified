...
int main(int argc, char** argv)
{
	...
	//载入原图
	//string pic_path = "F:\\my_git_reposity\\image_recognition_check_photo_modified\\image_recognition_check_photo_modified\\image_recognition_check_photo_modified\\edge_detect\\edge_detect_test_pic";
	...
	g_srcImage = imread(pic_path + "\\post2.jpg");  //工程目录下应该有一张名为1.jpg的素材图  
	...
	// 创建trackbar
	createTrackbar("Canny参数值：", "【效果图】Canny边缘检测", &g_cannyLowThreshold, 150, on_Canny);
	createTrackbar("Sobel参数值：", "【效果图】Sobel边缘检测", &g_sobelKernelSize, 10, on_Sobel);
